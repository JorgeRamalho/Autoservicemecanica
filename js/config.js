/**
 * Auto Service Mecânica — Configuração de acesso externo
 * URLs para visualização local e em rede antes da publicação
 */
export const APP_CONFIG = {
  ...
  /** Endereços de acesso ao site em desenvolvimento */
  access: {
  ...
  /** Contato da oficina (dados públicos de referência) */
  contact: {
    phone: '(11) 3456-7890',
